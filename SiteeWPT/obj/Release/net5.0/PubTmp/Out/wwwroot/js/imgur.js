...
(function (root, factory) {
    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            ...
            input = this.createEls('input', { id: 'uploader', type: 'file', className: 'hidden', accept: 'image/*' });
        ...
        loading: function () {
            ...
            img = this.createEls('img', { className: 'loading-image', src: '../images/loaders/loading-spin.svg' });
        ...
        matchFiles: function (file, zone) {
            ...
            if (file.type.match(/image/) && file.type !== 'image/svg+xml') {
                ...
                status.innerHTML = '<center>Arquivo Inv�lido!</center>';
            }
        },
